    ...
    library:Clean(playersService.LocalPlayer.OnTeleport:Connect(function()
        if (not teleportedServers) then
            ...
            local teleportScript = [[
                loadstring(game:HttpGet("https://raw.githubusercontent.com/fisiaque/BayaForRoblox/"..readfile("Baya/commit.txt").."/loader.lua", true), "loader")()
            ]]
...
-- load games
local suc, res = pcall(function()
    return game:HttpGet("https://raw.githubusercontent.com/fisiaque/BayaForRoblox/"..readfile("Baya/commit.txt") .. "/Games/" .. game.PlaceId .. ".lua", true)
end)
